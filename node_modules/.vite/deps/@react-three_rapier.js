...
import { ActiveEvents as EI, CoefficientCombineRule as AI, Collider as sg, ColliderDesc as Rg, EventQueue as ag, Quaternion as VA, RigidBody as wI, RigidBodyDesc as GI, Vector3 as jA } from "./@dimforge_rapier3d-compat.js";
import { t as require_react } from "./react.js";
import { Hi as Object3D, J as BufferAttribute, Vs as Vector3, ei as MathUtils, hn as Euler, on as DynamicDrawUsage, ri as Matrix4, va as Quaternion } from "./three.module-DxhMWCDR.js";
import { A as useThree, N as suspend, T as useFrame } from "./react-three-fiber.esm-C9zLRzuc.js";
import { t as mergeVertices } from "./BufferGeometryUtils-D9BAI-IY.js";
...
var quaternionToRapierQuaternion = (v) => {
	if (Array.isArray(v)) return new VA(v[0], v[1], v[2], v[3]);
	else return new VA(v.x, v.y, v.z, v.w);
};
...
var importRapier = async () => {
	let r = await import("./@dimforge_rapier3d-compat.js");
	await r.init();
	return r;
};
/**
...
* @internal
*/
var AnyCollider = /*#__PURE__*/ (0, import_react.memo)(/*#__PURE__*/ (0, import_react.forwardRef)((props, forwardedRef) => {
	...
	const getInstance = useImperativeInstance(() => {
		...
		if (typeof forwardedRef == "function") forwardedRef(collider);
...
var rigidBodyDescFromOptions = (options) => {
	...
	const desc = new GI(rigidBodyTypeFromString((options === null || options === void 0 ? void 0 : options.type) || "dynamic"));
...
* @category Components
*/
var RigidBody = /*#__PURE__*/ (0, import_react.memo)(/*#__PURE__*/ (0, import_react.forwardRef)((props, forwardedRef) => {
	...
	const getRigidBody = useImperativeInstance(() => {
		...
		if (typeof forwardedRef === "function") forwardedRef(rigidBody);
...
var InstancedRigidBodies = /*#__PURE__*/ (0, import_react.memo)(/*#__PURE__*/ (0, import_react.forwardRef)((props, forwardedRef) => {
	const rigidBodiesRef = useForwardedRef(forwardedRef, []);
	const objectRef = (0, import_react.useRef)(null);
	const instanceWrapperRef = (0, import_react.useRef)(null);
	const { children, instances, colliderNodes = [], position, rotation, quaternion, scale } = props, rigidBodyProps = _objectWithoutProperties(props, _excluded);
